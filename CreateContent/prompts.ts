...
export const searchImages = "We have a course in v{languageName} called \"v{courseName}\", the first module of the course is  v{sectionTitle} and the first paragraph of the module contains the following information: v{paragraphContent}\n\nConsidering the previous information, write in English a short and accurate phrase that can be used to search for images related to that paragraph in the context of the course and module.\n\nThe answer must be in Json format, following the next structure: {resp: phrase}"