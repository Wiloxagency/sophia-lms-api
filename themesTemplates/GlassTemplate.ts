  ...
  [
    {
      ...
      code: "00-02",
      description:
        "Slide con video cuadrado/vertical, Texto a la derecha o izquierda.",
      elements: {
        media: ["video-v"],
        title: {
          min: 1,
  ...
  [
    {
      ...
      description: "Slide sin fotos ni videos",
      elements: {
        media: ["icon-b", "icon-b", "icon-b", "icon-b"],
        title: {
          min: 1,
          max: 5,
        },
