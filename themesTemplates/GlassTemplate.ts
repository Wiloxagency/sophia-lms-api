...
export const GlassTemplate: Template[] = [
  ...
  [
    ...
    },
    {
      component: "svg",
      id: "svg1",
      image: "./assets/glass_objects/glassObj2.svg",
      width: "50%",
      top: "1%",
      right: "-30%",
      rotate: "-90deg",
  ...
  [
    ...
    },
    {
      ...
      titleFontSize: 3,
      titleLineHeight: 1,
      titleExtraClasses: "white-text-bg",
      text: "[text]",
      textFontSize: 2,
      textFontColor: "[PrimaryText]",
      textMarginTop: "2cqw",
  ...
  [
    {
      ...
      code: "01-00",
      order: 6,
      description: "Slide con asset horizontal",
      elements: {
        media: [
          "video-h",
          "icon-b"
    ...
    },
    {
      component: "card",
      id: "card1",
      extraClasses: "glass p-6 card-centered max-h-80 min-h-30",
      width: "25%",
      right: "4%",
      borderRadius: "1.5rem",
      bgColor: "[Primary]",
    ...
    },
    {
      component: "svg",
      id: "svg3",
      image: "./assets/glass_objects/glassObj3.svg",
      height: "40%",
      top: "80%",
      right: "-8%",
      rotate: "180deg",
  ...
  [
    ...
    },
    {
      component: "card",
      id: "card2",
      extraClasses: "p-6 glass min-h-35 max-h-50 content-top",
      width: "50%",
      right: "5%",
      top: "50%",
      borderRadius: "1.5rem",
  ...
  [
    ...
    },
    {
      component: "card",
      id: "card1",
      extraClasses: "p-6 justify-center items-center text-center glass-12-wbg",
      width: "50%",
      height: "50%",
      left: "0%",
      top: "0%",
