...
const LANGUAGE_IDENTIFIER_SUBSCRIPTION_KEY = process.env.LANGUAGE_IDENTIFIER_SUBSCRIPTION_KEY
...
const httpTrigger: AzureFunction = async function (context: Context, req: HttpRequest): Promise<void> {
    try {
        ...
        await saveLog(`Error identifying language. ` + error.message, "Error", "languageIdentifier()", "LanguageIdentifier")
    }
}
