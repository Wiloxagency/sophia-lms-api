export async function returnParsedHtmlString(htmlString: string) {
  ...
  let h1TagResults = [],
    h1TagMatches: RegExpExecArray;

  let h2TagResults = [],
    h2TagMatches: RegExpExecArray;

  let h3TagResults = [],
    h3TagMatches: RegExpExecArray;

  let h4TagResults = [],
    h4TagMatches: RegExpExecArray;

  let h5TagResults = [],
    h5TagMatches: RegExpExecArray;

  let h6TagResults = [],
    h6TagMatches: RegExpExecArray;

  let pTagResults = [],
    pTagMatches: RegExpExecArray;

  let ulTagResults = [],
    ulTagMatches: RegExpExecArray;
